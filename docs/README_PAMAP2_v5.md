...
V5 corrections: materialized inner CV splits, Windows-safe SVM `n_jobs=1`, `num_workers=0`, explicit CNN/RNN tensor shapes, grouped neural epoch selection, strict NPZ validation, explicit 100-feature contract.
