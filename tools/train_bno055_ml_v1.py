...
Models:
- RF: classical Random Forest on deterministic window features
- CNN: small 1-D CNN
...
def parse_args():
    ...
    p.add_argument("--model", choices=["rf", "cnn", "tcn"], default="rf")
...
def fit_predict_rf(Xtr, ytr, Xte, seed, trees):
...
def main():
    ...
    for fold, (tr, te) in enumerate(splits, 1):
        ...
        if args.model == "rf":
            ...
            pred = fit_predict_rf(Ftr, ytr, Fte, args.seed + fold, args.rf_trees)
        else:
